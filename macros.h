...
#define FIELD_VAL(field, val)                                                                                          \
    ({                                                                                                                 \
        static_assert(!__is_constexpr(val) || ((val) & ~(field##_Msk >> field##_Pos)) == 0,                            \
                      "value extends outside bounds of field");                                                        \
 ...
 */
#define SET_FIELD_SHIFTED(reg, field, val)                                                                             \
    do                                                                                                                 \
    {                                                                                                                  \
        static_assert(!__is_constexpr(val) || ((val) & ~(field##_Msk)) == 0,                                           \
                      "shifted value extends outside bounds of field");                                                \
